...
namespace JournalAPI.DTO
{
    ...
    public class JournalDto
    {
        ...
        public List<JournalBSDto> JournalBSs { get; set; } = new List<JournalBSDto>();

        [Required(ErrorMessage = "Journal Profit & Loss lines are required.")]
        public List<JournalPLDto> JournalPLs { get; set; } = new List<JournalPLDto>();
    }
}
